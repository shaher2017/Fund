  ...
  return (
    ...
    <Card sx={{ maxWidth: 345 }}>
      <CardHeader
        ...
        title={<span style={{fontSize:"20px", fontWeight:"bold"}}>{props.project.title}</span>}
...
<div style={{width:"90%", marginTop:"1rem",marginLeft:"5%"}}>
  <ProgressBar completed={((props.project.collected/props.project.funds)*100).toFixed(0)} maxCompleted={100} />
      ...
      <CardActions disableSpacing >
        ...
        { props.ids.includes(props.project._id)? null : <Button onClick={funding} style={{marginLeft:'2rem', width:"12rem"}} variant="contained" color="success">
          Fund
          </Button>}
      ...
      <div style={{width:"100%", display:"flex", justifyContent:"space-around", alignItems:"center", marginBottom:".5rem"}}>
          { props.ids.includes(props.project._id) ? <><Button  onClick={editing} style={{width:"40%"}}
           variant="contained" color="warning">
          Edit
          </Button>
          <Button  onClick={deleting} style={{width:"40%"}} variant="contained" color="error">
          Delete
          </Button></> : null  }
          </div>
    </Card>
